...
<table border="0" cellspacing="1" cellpadding="4" align="center" width="100%" class="bordercolor">
    <tr class="titlebg">
        <td align="center" [% IF colspan %] colspan="[% colspan %]"[% END %] class="largetext">
            [% loc('Add page translation') | html -%]
        </td>
    </tr>
    <tr class="windowbg">
        <td class="windowbg lual" style="padding: 7px;"[% IF colspan %] colspan="[% colspan %]"[% END %]>
            <form onSubmit="javascript:submit_save_translated_page_frm();return false;" name="save_translated_page_frm" id="save_translated_page_frm" action="[% bytestream(SESSION.ADM_URL, 'url_escape', 'A-Za-z0-9\/\-\.\_\~') %]/content/page_managetrans/[% page_id %]/save" method="post" accept-charset="[% TT_VARS.html_charset %]">
                <table class="w100">
                    <tr>
                        <td class="lual">
                        ...
                        <td class="w35 lual">
                            <input type="submit" value="   [% loc('Save translation') | html %]   " style="float:right;margin-right:10px;"/><br /><br />
                                <table class="w100 nwp">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="page_custom_title" id="page_custom_title" size="19" maxlength="128"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
