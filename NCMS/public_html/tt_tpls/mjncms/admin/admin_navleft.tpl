...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="bordercolor">
	...
	<tr class="windowbg2">
		<td class="smalltext" style="line-height: 1.3; padding-bottom: 3ex;">
			[% IF tt_action=='translation_list' %]<b>[% END %]<a href="[% bytestream(SESSION.ADM_URL, 'url_escape', 'A-Za-z0-9\/\-\.\_\~') %]/translations?rnd=[% SESSION.RND %]">[% loc('Translations pool') %]</a>[% IF tt_action=='translation_list' %]</b>[% END %]<br />
