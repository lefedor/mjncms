...
var DatePicker = new Class({
	...
	options: { 
		...
		format: 'd-m-Y',
		allowEmpty: true,
		inputOutputFormat: false,//'U', // default to unix timestamp //if false - set to format
	...
	initialize: function(attachTo, options) {
		...
		if(!this.options.inputOutputFormat){
			this.options.inputOutputFormat = this.options.format;
		}
