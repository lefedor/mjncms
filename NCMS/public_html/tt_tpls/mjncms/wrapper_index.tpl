...
<html xmlns="http://www.w3.org/1999/xhtml" lang="[% TT_VARS.html_lang %]" xml:lang="[% TT_VARS.xml_lang %]">
    <head>
        <title>[% TT_VARS.title | html %]</title>
        <meta http-equiv="Content-Type" content="text/html; charset=[% TT_VARS.html_charset %]" />
        [% IF TT_VARS.keywords -%]
            <meta name="keywords" content="[% TT_VARS.keywords | html %]" />
        [% END -%]
        [% IF TT_VARS.description -%]
            <meta name="description" content="[% TT_VARS.description | html %]" />
        [% END -%]
